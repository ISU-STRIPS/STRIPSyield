...
units  <- c(NA, NA, "Integer", "Hectare", NA, NA, "Hectare", NA, "% (hundreds)", NA, "% (hundreds)", NA, NA, "Feet", "Integer", "Date", "Unknown", "Unknown", NA, "Feet", "MPH", "Degrees", "Seconds", "Pounds per second", "% (hundreds)", "Bushels per acre")
...
To homogenenize measurement units, we rescale the columns `distance` and `swath` width from inches to foot.
...
To build our consolidated shapefiles, we decided to keep only those variables recorded for every site and year. The only exceptions is direction, available for years 2013-2015 and 2011, which we kept as partial information may be relevant for our future research.
