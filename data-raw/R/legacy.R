...
legacy_raw_yield <-
  readr::read_csv("data-raw/legacy/AllSitesEdit.csv") %>%
...
legacy_yield <-
  readr::read_csv("data-raw/legacy/STRIPS1YieldByWatershed2007_2015.csv") %>%
...
legacy_yield_conversion$Mgha_per_buac =
  Mgha_per_lbsac * legacy_yield_conversion$lbs_per_bushel
