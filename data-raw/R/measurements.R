...
#' @param marketMoisture market moisture content (percentage). Set to zero if
#'   you want the dry yield.
#' @return Yield (bu/ac)
#' @references Best Management Practices for Collecting AccurateYield Data and
#'   Avoiding Errors During Harvest
